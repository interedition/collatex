...
public class NormalizedWitness implements Iterable<INormalizedToken>, IWitness {
	...
	public NormalizedWitness(final String sigil,
			final List<INormalizedToken> tokens) {
		this.sigil = sigil;
		this.tokens = tokens;
	}
	 ...
	 * 
	 * @see
	 * eu.interedition.collatex.experimental.ngrams.data.IRealWitness#getTokens
	 * ()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * eu.interedition.collatex.experimental.ngrams.data.IRealWitness#getSigil()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * eu.interedition.collatex.experimental.ngrams.data.IRealWitness#iterator()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * eu.interedition.collatex.experimental.ngrams.data.IRealWitness#size()
	 */
	@Override
	public int size() {
		return tokens.size();
