...
public class HermansTest extends AbstractTest {
  ...
  public void testHermansText2() {
    ...
    try {
      ...
      logging.println(new MatchTableSerializer(buildMatrix).toHtml(firstVersion));
      logging.close();
  ...
  public void testHermansText2aWithMocking() throws XMLStreamException {
    ...
    MatchTable matrix = MatchTable.create(base, witnesses[1], new EqualityTokenComparator());
