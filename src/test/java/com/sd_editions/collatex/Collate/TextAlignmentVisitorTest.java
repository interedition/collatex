...
public class TextAlignmentVisitorTest extends TestCase {
  ...
  //  public void testPhraseAlignment_AtTheStart() throws FileNotFoundException, IOException, BlockStructureCascadeException {
  ...
  //    assertEquals("replacement: cloverfield, the moon get eclipsed", table.get(1, 5).toString());
