...
public class TextAlignmentVisitorTest extends TestCase {
	...
	public void testSentence() throws FileNotFoundException, IOException,
	...
	public void testPunctuation() throws FileNotFoundException, IOException,
			BlockStructureCascadeException {
	...
	public void testVariant() throws FileNotFoundException, IOException,
			BlockStructureCascadeException {
	...
	public void testOmission_InTheMiddle() throws FileNotFoundException,
			IOException, BlockStructureCascadeException {
	...
	public void testOmission_AtTheStart() throws FileNotFoundException,
			IOException, BlockStructureCascadeException {
	...
	public void testOmission_AtTheEnd() throws FileNotFoundException,
			IOException, BlockStructureCascadeException {
	...
	public void testAddition_InTheMiddle() throws FileNotFoundException,
			IOException, BlockStructureCascadeException {
	...
	public void testAddition_AtTheEnd() throws FileNotFoundException,
			IOException, BlockStructureCascadeException {
	...
	public void testAddition_AtTheStart() throws FileNotFoundException,
			IOException, BlockStructureCascadeException {
	...
	// public void testPhraseAlignment_AtTheStart() throws FileNotFoundException,
	// IOException, BlockStructureCascadeException {
	// Table table = alignmentTable("i saw cloverfield yesterday", "i saw the moon
	// get eclipsed yesterday");
	// assertEquals("identical: i", table.get(1, 2).toString());
	// assertEquals("identical: saw", table.get(1, 4).toString());
	// assertEquals("replacement: cloverfield, the moon get eclipsed",
	// table.get(1, 5).toString());
	// assertEquals("identical: yesterday", table.get(1, 6).toString());
	// }

	private Table alignmentTable(String baseString, String witnessString)
			throws FileNotFoundException, IOException, BlockStructureCascadeException {
	...
	// public void testMultipleAdditions() throws FileNotFoundException,
	// IOException, BlockStructureCascadeException {
	// // black cat
