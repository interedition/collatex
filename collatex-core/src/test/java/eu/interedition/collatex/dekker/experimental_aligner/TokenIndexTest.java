...
public class TokenIndexTest extends AbstractTest {
    ...
    public void testCaseDanielStoeklLCPIntervals() {
        ...
        assertLCP_Interval(3, 1, 3, blocks.get(0)); // a
        assertLCP_Interval(6, 1, 2, blocks.get(1)); // b
        assertLCP_Interval(8, 2, 2, blocks.get(2)); // c d
        assertLCP_Interval(10, 1, 3, blocks.get(3)); // d
        assertLCP_Interval(0, 0, 15, blocks.get(4)); // TODO: remove!
        assertLCP_Interval(13, 1, 2, blocks.get(5)); // e
