 ...
 */
public class DekkerAlgorithm1 extends EditGraphAligner implements InspectableCollationAlgorithm {
    public DekkerAlgorithm1() {
        super();
    }

    public DekkerAlgorithm1(Comparator<Token> comparator) {
        super(comparator);
    }
