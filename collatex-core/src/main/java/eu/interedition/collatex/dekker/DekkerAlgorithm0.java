...
public class DekkerAlgorithm0 extends CollationAlgorithm.Base implements InspectableCollationAlgorithm {
    ...
    public DekkerAlgorithm0() {
        this(new EqualityTokenComparator());
    }

    public DekkerAlgorithm0(Comparator<Token> comparator) {
